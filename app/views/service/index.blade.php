    ...
    @foreach($service as $key => $value)
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-small btn-success" href="{{ URL::to('service/' . $value->id) }}">Show this Service</a>

                <!-- edit this nerd (uses the edit method found at GET /nerds/{id}/edit -->
                <a class="btn btn-small btn-info" href="{{ URL::to('service/' . $value->id . '/edit') }}">Edit this Service</a>
