...
<br/>
<h1>Edit Service, {{ $service->serviceName }}</h1>
...
{{ Form::model($service, array('route' => array('service.update', $service->id), 'method' => 'PUT')) }}
    ...
    <div class="form-group">
        ...
        {{ Form::text('service_name', $service->serviceName, array('class' => 'form-control')) }}
    </div>

    <div class="form-group">
        {{ Form::label('service_status', 'Service Status') }}
        {{ Form::select('service_status', array('0' => 'Inactive', '1' => 'Active'), null, array('class' => 'form-control')) }}
    </div>
